...
#ifndef _UGPIO_VERSION_H_
#define _UGPIO_VERSION_H_
...
#define LIBUGPIO_VERSION_MICRO (1)

/* The full version, like 1.2.3 */
#define LIBUGPIO_VERSION        0.0.1

/* The full version, in string form (suited for string concatenation) */
#define LIBUGPIO_VERSION_STRING "0.0.1"
